...
<main>
    <div id="primary" class="blue4 p-t-b-100 height-full responsive-phone">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <!-- <img src="<?php //echo base_url('assets/img/basic/stones.png');?>" alt="/"> -->
                    <img src="<?php echo base_url('assets/images/sc.png'); ?>" class="img-icon" alt="">
                </div>
                <div class="col-lg-6">
                    <div class="text-white text-center p-t-100">
                        ...
                        <div class="p-t-b-20"><a onclick="goBack()" class="btn btn-primary btn-lg"><i
